...
class MonthlyContract extends Model
{
    ...
    public static function validationRules()
    {
        return [
            ...
            'monthly_contract_number' => 'nullable|string',
            ...
            'contract_period' => "nullable|date",
            'bill_cycle_date' => "nullable|date",
        ];
    }
...
//        });
    ...
    public static function generateMonthlyContractNumber( $clientName, $bookingId)
    {
        $separators = '/[\s\-._]+/';
    ...
    {
        return $this->hasOne(DutyDate::class);
    }
