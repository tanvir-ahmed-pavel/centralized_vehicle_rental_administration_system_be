...
class VehicleFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'per_km_rate' => $this->faker->randomFloat(2, 10, 50),
            'body_rent_per_day' => $this->faker->randomFloat(2, 1500, 100000),
            ...
            'vendor_per_km_rate' => $this->faker->randomFloat(2, 10, 50),
            'vendor_body_rent_per_day' => $this->faker->randomFloat(2, 1500, 100000),
