...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('monthly_contracts', function (Blueprint $table) {
            ...
            $table->enum('status', array('Contract Created', 'On Duty', 'On Hold', 'To Make Invoice', "Invoice Created & Awaiting Payment", "Partially Paid", "Payment Overdue", "Paid & Closed"))->default("Booking Created");
